...
function isDbConfigured() {
  return !!(process.env.DATABASE_URL || (process.env.PGHOST && process.env.PGDATABASE && process.env.PGUSER))
}

export function getPool() {
  if (!isDbConfigured()) {
    throw new Error('Database is not configured. Set DATABASE_URL or PGHOST/PGDATABASE/PGUSER environment variables.')
  }
